...
namespace client::input
{
  namespace internal
  {
    ...
    public:
      ...
      static void KeyCallback(GLFWwindow* window, int key, int scancode, int action, int mods)
      {
        ...
        case GLFW_REPEAT: pInput->_buttonStates[key] = ButtonState::REPEAT; break;
        default: break;
        }
      ...
      _eventBus(eventBus)
  {
    ...
    glfwSetWindowFocusCallback(window, internal::InputAccess::WindowFocusCallback);
    glfwSetCursorEnterCallback(window, internal::InputAccess::CursorEnterCallback);
    glfwSetMouseButtonCallback(window, internal::InputAccess::MouseButtonCallback);
    glfwSetScrollCallback(window, internal::InputAccess::ScrollCallback);
    glfwSetKeyCallback(window, internal::InputAccess::KeyCallback);
    glfwSetCharCallback(window, internal::InputAccess::CharCallback);
    glfwSetMonitorCallback(internal::InputAccess::MonitorCallback);
