...
{
  RenderingSystem::RenderingSystem(::ecs::Scene* scene, EventBus* eventBus, GLFWwindow* window)
  ...
  void RenderingSystem::Update([[maybe_unused]] double dt)
  {
    ...
    auto view = SceneRegistry()->view<::ecs::Transform, ::ecs::Sprite>();
  ...
  void RenderingSystem::Listener(::ecs::AddSprite& e)
  {
